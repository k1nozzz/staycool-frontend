...
@Component({
  selector: 'app-psychologist-settings',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './psychologist-settings-component.html',
  styleUrl: './psychologist-settings-component.css'
})
export class PsychologistSettings implements OnInit {
